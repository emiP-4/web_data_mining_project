...
# CONFIG
# ─────────────────────────────────────────────
INPUT_JSONL    = Path("./data/samples/crawler_output.jsonl")
OUTPUT_CSV     = Path("./data/samples/extracted_knowledge.csv")
RELATIONS_CSV  = Path("./data/samples/extracted_relations.csv")
